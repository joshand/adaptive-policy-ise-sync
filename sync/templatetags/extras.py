        ...
        if v.iseserver == element or v.organization == element:
            ...
            if (type(v) == Tag and not v.tag) or (type(v) == ACL and not v.acl) or (type(v) == Policy and not v.policy):
                ...
                if element == elements["src"]:
                    ...
                    if a is True:
                        return '<font color="green">Matches Source</font> <i class="md-icon icon icon-info_8" style="font-size: 16px;" onmouseover="showtooltip(\'' + base64encode(det) + '\')" onmouseout="hidetooltip()"></i>'
                    elif a is False:
                        return '<font color="red">Update</font>  <i class="md-icon icon icon-info_8" style="font-size: 16px;" onmouseover="showtooltip(\'' + base64encode(det) + '\')" onmouseout="hidetooltip()"></i>'
                    else:
                        # return '<font color="lightgreen">Present</font>  <i class="md-icon icon icon-info_8" style="font-size: 16px;" onmouseover="showtooltip(\'' + base64encode(det) + '\')" onmouseout="hidetooltip()"></i>'
                        # return '<font color="orange">Delete</font>'
                        if element != elements["src"] and not elements["sync"].reverse_sync:
