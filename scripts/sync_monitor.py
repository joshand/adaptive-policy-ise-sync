...
def calculate_gen_sync_objects(sync, log):
    ...
    for o in objs:
        ...
        v, _ = Generic.objects.update_or_create(key_value=sig_val, elementsync=sync, generictype=o.generictype,
                                                defaults={"name": o.get_data("name", default_val=sig_val),
                                                          "description": o.get_data("description", default_val=def_val),
                                                          "element": src})
        o.generic = v
        o.save()
